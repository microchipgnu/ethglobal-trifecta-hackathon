...
export default function Page({
  ...
  return (
    <main
      ...
      style={{
        background:
          "url('/bg-image.png'), linear-gradient(to bottom, #0E0F15, #160E2A)",
      ...
      <div className="flex flex-col w-full md:w-7/8 min-h-screen mx-auto p-2 justify-between items-center space-y-8">
        ...
        <div className="bg-slate-800/70 rounded-xl border border-gray-800 overflow-hidden shadow-lg">
          ...
          <div className="p-6">
            ...
            {/* Show a message if telegramId is missing */}
            {!id && (
              <div className="bg-yellow-900/30 text-yellow-400 p-4 rounded-lg border border-yellow-800">
                <p>
                  LOADING ... , if the site does not update your invitation link
                  might be broken, reach out to the team!
                </p>
              </div>
            )}
          </div>
