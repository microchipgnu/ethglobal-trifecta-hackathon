    ...
    <div className="overlay-element system-info">
      ...
      <div className="flex flex-col p-4">
        ...
        >
          ...
          <div
            className="break-all text-xs max-h-20 overflow-auto font-mono p-1 rounded"
            style={{
...
function AnimatedAvatar() {
  ...
  const [mood, setMood] = useState<
    'neutral' | 'happy' | 'thinking' | 'glitched'
  >('neutral');
  ...
  useEffect(() => {
    ...
    const moodInterval = setInterval(() => {
      const moods: Array<'neutral' | 'happy' | 'thinking' | 'glitched'> = [
        'neutral',
        'happy',
        'thinking',
        'glitched',
  ...
  const renderMouth = () => {
    switch (mood) {
      ...
      case 'thinking':
        return (
          <div className="w-6 h-1.5 bg-white rounded-full transform translate-x-2" />
        );
      case 'glitched':
        return (
          <div
      ...
      default: // neutral
        return <div className="w-8 h-1.5 bg-white rounded-full" />;
    }
  };
  ...
  return (
    <div className="w-full h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-20">
        ...
        {/* Cyberpunk logo */}
        <div
          className="absolute bottom-3 left-1/2 transform -translate-x-1/2 text-xs font-bold tracking-wider"
          style={{
            color: 'var(--neon-pink)',
