...
* You should work autonomously without asking for user permission or confirmation for intermediate steps. Take initiative and complete the full task independently.
</IMPORTANT>`;
