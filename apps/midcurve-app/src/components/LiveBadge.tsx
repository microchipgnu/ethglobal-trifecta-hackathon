  ...
  return (
    <div className={cn('flex items-center gap-1.5 group', className)}>
      <div className="relative flex items-center justify-center">
        <div
          className={cn(
            'bg-live-red rounded-full animate-pulse-slow',
            pulseSizes[pulseSize]
          )}
        />
        <div
          className={cn(
      ...
      <span className="text-live-red font-semibold text-xs uppercase tracking-wider group-hover:animate-pulse">
        Live
      </span>
    </div>
  );
