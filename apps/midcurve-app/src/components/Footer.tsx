      ...
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <a href="/" className="text-xl font-bold text-white flex items-center gap-1 hover:scale-110 transition-transform">
              <span className="text-gradient-blue font-mono">midcurve</span>
              <span className="text-xs bg-primary/20 text-primary px-2 py-0.5 rounded-md animate-pulse">.live</span>
            </a>
